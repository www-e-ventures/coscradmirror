...
cp -R ./scripts/arangodb/arango $ARANGO_DOCKER_LOCAL_DIR
...
-e ARANGO_DB_NAME_HAIDA=$ARANGO_DB_NAME_HAIDA \
-e ARANGO_DB_HAIDA_USER=$ARANGO_DB_HAIDA_USER \
-e ARANGO_DB_HAIDA_USER_PASSWORD=$ARANGO_DB_HAIDA_USER_PASSWORD \
-e ARANGO_DOCKER_VOLUME_SCRIPTS_DIR=$ARANGO_DOCKER_VOLUME_SCRIPTS_DIR \
-e SETUP_MODE=$SETUP_MODE \
