    ...
    return (
        <div className="page">
            ...
            <p>
                ...
                is a grant funding opportunity sponsored by the Irving K. Barber Learning Centre at
                the University of British Columbia, Museum of Anthropology at the University of
                British Columbia, and the First Nations Technology Council.”
            </p>
            ...
            <p>
                ...
                as part of the 7 year project, First Nations Languages in the Twenty-first Century:
                Looking Back, Looking Forward. This project was funded by a partnership grant from
                the Social Sciences and Humanities Research Council (SSHRC).
            </p>

            <h3>New Relationship Trust</h3>
            <p style={{ margin: '0' }}>
                The language videos "Ts’eman Ts’elhgen" and “ʔEts’eteqash” were produced by William
                Myers as part of a project funded through the{' '}
                <a
