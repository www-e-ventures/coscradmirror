...
export function Term(props: TermsDetailComponentProps) {
            ...
            <div>
                ...
                >
                    <div className="termNot">
                        <h1>
                            {' '}
                            Term not found <ErrorTwoToneIcon />
                        </h1>
    ...
    const { id, contributor, term, termEnglish, audioURL } = termData
    ...
    return (
        <div>
            ...
            >
                ...
                <div className="termClass">
                    <div className="termInfo">Contributor:&nbsp;</div>
                    {` ${contributor}`}
                </div>
                <div className="termClass">{`Term ID: ${id}`}</div>
                <div>
